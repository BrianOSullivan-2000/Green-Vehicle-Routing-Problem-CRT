...
summary_by_hr = feb_traffic_data.groupby("Hour_in_Day")["Sum_Volume"].describe()

# summary stats by hour and by weekday/weekend
summary_by_hr_wdwe = feb_traffic_data.groupby(["Hour_in_Day", "Day_Type"])["Sum_Volume"].describe()
...
summary_by_hr_d = feb_traffic_data.groupby(["Hour_in_Day", "Day_in_Week"])["Sum_Volume"].describe()
...
plt.title("February 2020: Mean Vehicle Count by Hour in Day")
plt.grid(True)
